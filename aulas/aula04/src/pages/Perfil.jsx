...
function Perfil () {
  ...
  const validadores = {
    nome: {
      ...
      minLength: {value: 3, message: "Nome deve conter mais de 2 caracteres"}
    },
    email: {
    ...
    telefone: {
      min: {value: 0, message: "Telefone e um numero"},
      pattern: {value:/^\(?[1-9]{2}\)? ?9[0-9]{4}-?[0-9]{4}$/, message: "Telefone e invalido"}
    },
  };
  ...
  <>
    ...
    <form onSubmit={handleSubmit(onSalvar)}>
      ...
      <div>
        <label htmlFor="nascimentos">Data de Nascimento</label>
